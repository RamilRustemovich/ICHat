...
final class InsertableTextField: UITextField {
    ...
    override init(frame: CGRect) {
        ...
        let image = UIImage(systemName: "smiley")?.withRenderingMode(.alwaysTemplate)
...
struct TextFieldVCProvider: PreviewProvider {
    ...
    struct ContainerView: UIViewControllerRepresentable {
        ...
        func makeUIViewController(context: UIViewControllerRepresentableContext<TextFieldVCProvider.ContainerView>) ->  UIViewController {
