...
//  IChat
//
//  Created by Ramil Davletshin on 24.02.2021.
...
extension ChatsViewController {
    ...
    func configureCameraIcon() {
        ...
        cameraItem.tintColor = .glamorousPink
...
extension ChatsViewController: MessagesDisplayDelegate {
    func backgroundColor(for message: MessageType, at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView) -> UIColor {
        return isFromCurrentSender(message: message) ? .white : .glamorousPink
    }
    
    func textColor(for message: MessageType, at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView) -> UIColor {
        isFromCurrentSender(message: message) ? .lightBlack : .white
    }
